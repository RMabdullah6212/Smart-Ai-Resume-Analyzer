    ...
    "pakistan_tech": [
        {
            ...
            "description": "Pakistan's largest IT services company",
...
JOB_MARKET_INSIGHTS = {
    ...
    "top_locations": [
        {"name": "Karachi", "jobs": "50,000+", "icon": "fas fa-city"},
        {"name": "Lahore", "jobs": "35,000+", "icon": "fas fa-city"},
        {"name": "Islamabad", "jobs": "30,000+", "icon": "fas fa-city"},
        {"name": "Hyderabad", "jobs": "25,000+", "icon": "fas fa-city"},
        {"name": "Peshawar", "jobs": "20,000+", "icon": "fas fa-city"},
        {"name": "Rawalpindi", "jobs": "15,000+", "icon": "fas fa-city"},
        {"name": "Multan", "jobs": "10,000+", "icon": "fas fa-city"},
