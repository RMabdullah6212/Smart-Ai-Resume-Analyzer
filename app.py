        ...
        with col2:
            ...
            <p style='text-align: center;'>
                Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | Developed by 
                    <b>Muhammad Abdullah (F22BSEEN1E02022)</b>
                </a>
            </p>
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/RMabdullah6212'}"
                     alt="Muhammad Abdullah"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://www.linkedin.com/in/mabdullah6212/';">
                <h2 class="profile-name">Muhammad Abdullah (F22BSEEN1E02022)</h2>
                <p class="profile-title">Full Stack Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/RMabdullah6212" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/mabdullah6212/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:abdullahaslam6212@gmail.com" class="social-link" target="_blank">
